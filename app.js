...
import csv from 'csv-parser' // allows app to read  csv files
...
app.use(express.static(path.join(import.meta.dirname, 'public'))) // .static means we are creating a static website using express
